...
public class TimeGraphViewer implements ITimeDataProvider, SelectionListener {
        ...
        fTimeGraphCtrl.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == '+') {
                    ...
                    selectNextMarker(false);
                } else if (e.character == ',') {
                    selectPrevMarker(false);
                } else if (e.character == '>') {
    ...
    private void selectNextMarker(boolean extend) {
    ...
    private void selectPrevMarker(boolean extend) {
        List<IMarkerEvent> markers = getTimeGraphControl().getMarkers();
        if (markers == null) {
            return;
        }
