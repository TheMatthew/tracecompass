 ...
 * @since 2.0
 */
public abstract class TmfTraceAdapterFactory implements IAdapterFactory {
    ...
    public synchronized void dispose() {
        ...
        for (Object adapter : fAdapters.values()) {
