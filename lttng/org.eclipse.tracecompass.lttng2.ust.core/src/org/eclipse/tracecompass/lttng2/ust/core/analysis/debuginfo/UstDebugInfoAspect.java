...
import org.eclipse.tracecompass.lttng2.ust.core.analysis.debuginfo.UstDebugInfoAnalysisModule.LoadedBinaryFile;
...
public class UstDebugInfoAspect implements ITmfEventAspect {
    ...
    public @Nullable TmfCallsite resolve(ITmfEvent event) {
        ...
        LoadedBinaryFile file = module.getMatchingFile(ts, vpid, ip);
        if (file == null) {
            return null;
        }
    ...
    private static boolean isMainBinary(LoadedBinaryFile file) {
        /*
