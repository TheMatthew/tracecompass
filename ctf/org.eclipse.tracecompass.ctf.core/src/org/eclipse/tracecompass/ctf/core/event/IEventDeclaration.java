...
public interface IEventDeclaration {
     ...
     * @since 1.0
     */
    EventDefinition createDefinition(CTFStreamInputReader streamInputReader,ICompositeDefinition eventHeader, @NonNull BitBuffer input, long timestamp) throws CTFException;
