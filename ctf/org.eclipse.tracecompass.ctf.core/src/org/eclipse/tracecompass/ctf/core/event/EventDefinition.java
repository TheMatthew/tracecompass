...
public final class EventDefinition implements IDefinitionScope {
    ...
    public EventDefinition(IEventDeclaration declaration,
        ...
        fCpu = streamInputReader == null? -1: streamInputReader.getCPU();
    ...
    // used to avoid static error or API error false dichotomy
    @Deprecated
    private final CTFStreamInputReader fDummy = null;
    /**
     * Gets the stream input reader that this event was made by
     *
     * @return nothing, throws an exception instead
     *
     * @deprecated the event does not contain back references
     */
    @Deprecated
