...
public class TraceDeclarationParser extends AbstractScopedCommonTreeParser {
    ...
    @Override
    public Object parse(CommonTree traceDecl, ICommonTreeParserParameter param) throws ParseException {
        ...
        if (left.equals(MetadataStrings.MAJOR)) {
            ...
            UUID uuid = (UUID) UUIDParser.INSTANCE.parse(rightNode, null);
            ...
            IDeclaration packetHeaderDecl = TypeSpecifierListParser.INSTANCE.parse(typeSpecifier, new TypeSpecifierListParser.Param(trace, null, null, getCurrentScope()));
