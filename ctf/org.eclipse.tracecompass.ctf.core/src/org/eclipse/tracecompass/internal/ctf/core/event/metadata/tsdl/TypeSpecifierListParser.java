...
public class TypeSpecifierListParser extends AbstractScopedCommonTreeParser {
    ...
    public IDeclaration parse(CommonTree typeSpecifierList, ICommonTreeParserParameter param, String errorMsg) throws ParseException {
        ...
        case CTFParser.FLOATING_POINT:
            declaration = (IDeclaration) FloatDeclarationParser.INSTANCE.parse(firstChild, new FloatDeclarationParser.Param(trace), null);
            break;
        case CTFParser.INTEGER:
            declaration = IntegerDeclarationParser.INSTANCE.parse(firstChild, new IntegerDeclarationParser.Param(trace), null);
            break;
        case CTFParser.STRING:
            declaration = StringDeclarationParser.INSTANCE.parse(firstChild, null, null);
            break;
        case CTFParser.STRUCT:
            declaration = StructParser.INSTANCE.parse(firstChild, new StructParser.Param(trace, identifier, getCurrentScope()), null);
        ...
        case CTFParser.VARIANT:
            declaration = VariantParser.INSTANCE.parse(firstChild, new VariantParser.Param(trace, getCurrentScope()), null);
            break;
        case CTFParser.ENUM:
            declaration = EnumParser.INSTANCE.parse(firstChild, new EnumParser.Param(trace, getCurrentScope()), null);
            break;
