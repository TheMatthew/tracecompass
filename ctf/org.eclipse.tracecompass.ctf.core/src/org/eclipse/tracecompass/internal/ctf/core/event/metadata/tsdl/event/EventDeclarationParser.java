...
public final class EventDeclarationParser extends AbstractScopedCommonTreeParser {
    ...
    public EventDeclaration parse(CommonTree eventDecl, ICommonTreeParserParameter param) throws ParseException {
        ...
        if (left.equals(MetadataStrings.NAME2)) {
            ...
            IDeclaration contextDecl = TypeSpecifierListParser.INSTANCE.parse(typeSpecifier, new TypeSpecifierListParser.Param(fTrace, null, null, getCurrentScope()));
            ...
            fieldsDecl = TypeSpecifierListParser.INSTANCE.parse(typeSpecifier, new TypeSpecifierListParser.Param(fTrace, null, null, getCurrentScope()));
