    ...
    public EnumDeclaration parse(CommonTree theEnum, ICommonTreeParserParameter param) throws ParseException {
        ...
        for (CommonTree child : children) {
            ...
            case CTFParser.ENUM_CONTAINER_TYPE: {
                ...
                containerTypeDeclaration = EnumContainerParser.INSTANCE.parse(child, new EnumContainerParser.Param(trace, getCurrentScope()));
                break;
            }
            default:
        ...
        if (enumBody != null) {
            ...
            /* Parse the body */
            EnumBodyParser.INSTANCE.parse(enumBody, new EnumBodyParser.Param(enumDeclaration, enumName, getCurrentScope()));
