...
public class TestInvalidCtfTrace {
    ...
    static {
        // metadata
        ERRORS.put("array-redefinition", "MismatchedTokenException");
        ERRORS.put("array-size-identifier", "Is not an integer: x");
        ERRORS.put("array-size-keyword", "NoViableAltException");
        ERRORS.put("array-size-negative", "Array length is negative");
        ERRORS.put("array-size-not-present", "NoViableAltException");
        ...
        ERRORS.put("struct-field-name-keyword", "NoViableAltException");
        // streams
